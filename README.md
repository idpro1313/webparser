...
Умный парсер веб-страниц: загрузка HTML, извлечение основного текста, структурированная выжимка через **OpenAI-compatible** Chat Completions API, сохранение в **Markdown**. Карта для агента — **`plans/`**; документация для людей — **`docs/README.md`**.
