...
- preserve or update stable `[Module][function][BLOCK_NAME]` markers when **behavior-changing branches** move; keep mutually exclusive arms distinguishable (`rules/grace-logging.md`)
