...
3. Require the worker to:
   ...
   - add or update module-local tests only
     - preserve or add required stable log markers for **behavior-changing branches** (including else arms, early returns, and structured error paths), per `rules/grace-logging.md`
