...
4. `docs/technology.xml` — stack, observability (**ветвления в логах**), testing; см. комментарии в шаблоне и `rules/grace-logging.md`
5. `docs/development-plan.xml` — phases, modules, contracts
6. `docs/verification-plan.xml` — tests, traces, per-branch log markers, and execution gates
