...
- Files with stable log markers on **behavior-changing branches** (not only happy path), per `rules/grace-logging.md`
- Test files that assert log markers or traces per scenario when trajectory matters
